...
Table \ref{tab:ChoosedbSNPversion} shows which dbSNP version to choose for a specified genome.
...
It took about 1.5 hour to prepare all annotations for ENSEMBL v66 in our tests.
